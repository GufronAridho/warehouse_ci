                    ...
                    <table class="table table-bordered table-striped table-hover table-custom" id="table_detail">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width:10%;">Storage Type</th>
                                <th class="text-center" style="width:10%;">Rack</th>
                                <th class="text-center" style="width:10%;">Bin</th>
                                <th class="text-end" style="width:10%;">Capacity</th>
                                <th class="text-center" style="width:10%;">Material Type Allowed</th>
                                ...
                                <div class="card-body">
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="add_storage_type" name="storage_type" required>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="edit_storage_type" name="storage_type" required>
                                        </div>
                                        <div class="col-md-6">
