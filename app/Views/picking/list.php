                            ...
                            <div class="row w-100 g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-light" id="orderNo" value="123" readonly />
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-light" id="lineCode" value="123" readonly />
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-light" id="cellName" value="123" readonly />
            ...
            <div class="card shadow-sm rounded-3 custom-card-purple card-table">
                <div class="card-body p-4">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover table-custom w-100" id="table_detail">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Rack - Bin</th>
